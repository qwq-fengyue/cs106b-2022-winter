...
void flow(const Grid<double>& terrain, Grid<bool>& res, Queue<GridLocation>& queue, GridLocation location, double height) {
    if (terrain.inBounds(location) && terrain[location] <= height && res[location] == false) {
            res[location] = true;
